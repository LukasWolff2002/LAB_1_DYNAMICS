...
Resonance is a phenomenon that occurs when the frequency of an external force matches the natural frequency of a system. This leads to a significant increase in the amplitude of oscillations, which can cause structural failure if not properly managed. 
